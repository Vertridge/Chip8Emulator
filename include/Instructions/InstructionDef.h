...
const std::array<InstructionDef, 35> InstructionDefinitions{{
    ...
    {U(0x3000), Opcode::SE, 2, {U(0xF000), U(0x0F00), U(0x00FF), U(0x0000)}},
    {U(0x4000), Opcode::SNE, 2, {U(0xF000), U(0x0F00), U(0x00FF), U(0x0000)}},
    {U(0x5000), Opcode::SE, 2, {U(0xF00F), U(0x0F00), U(0x00F0), U(0x0000)}},
    {U(0x6000), Opcode::LD, 2, {U(0xF000), U(0x0F00), U(0x00FF), U(0x0000)}},
    {U(0x7000), Opcode::ADD, 2, {U(0xF000), U(0x0F00), U(0x00FF), U(0x0000)}},
    {U(0x8000), Opcode::LD, 2, {U(0xF00F), U(0x0F00), U(0x00F0), U(0x0000)}},
    ...
    {U(0x8004), Opcode::ADD, 2, {U(0xF00F), U(0x0F00), U(0x00F0), U(0x0000)}},
    ...
    {U(0x9000), Opcode::SNE, 2, {U(0xF00F), U(0x0F00), U(0x00F0), U(0x0000)}},
    {U(0xA000), Opcode::LD, 1, {U(0xF000), U(0x0FFF), U(0x0000), U(0x0000)}},
    ...
    {U(0xE007), Opcode::LD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
    {U(0xE00A), Opcode::LD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
    {U(0xE015), Opcode::LD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
    {U(0xE018), Opcode::LD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
    {U(0xE01E), Opcode::ADD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
    {U(0xE029), Opcode::LD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
    {U(0xE033), Opcode::LD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
    {U(0xE055), Opcode::LD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
    {U(0xE065), Opcode::LD, 1, {U(0xF0FF), U(0x0F00), U(0x0000), U(0x0000)}},
}};
